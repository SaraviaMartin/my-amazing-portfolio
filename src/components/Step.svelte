...
gap-4 rounded-lg border border-solid boprder-violet-700 text-center group
cursor-pointer hover:border-violet-400 duration-200">
    ...
    <h3 class="font-medium text-xl sm:text2xl md:text-3xl">{step.name}</h3>
    <slot/>
    <div class="flex-1 flex justify-beteen gap-4 items-center">
        ...
        relative after:absolute after:top-0 after:h-0 after:right-full
         after:w-full after:h-full after:bg-white after:duration-200 hover:after:translate-x-full after:z-[-1] overflow-hidden">
